...
function fizzBuzz(numero) {
  ...
  if (numero / 5 === Math.floor(numero / 5) && numero / 3 === Math.floor(numero / 3)) { return 'fizzbuzz' }
  else if (numero / 3 === Math.floor(numero / 3)) { return 'fizz' }
  else if (numero / 5 === Math.floor(numero / 5)) { return 'buzz' }
  else { return numero };
}
